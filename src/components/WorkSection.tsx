...
<div className="md:hidden w-full flex flex-col gap-8">
  {filteredProjects.map((project, index) => (
    <motion.a
      ...
      className="block"
    >
      <div className="overflow-hidden rounded-2xl shadow-lg bg-[#D7C3AB]">
      ...
      <div className="pt-5 px-1">
        <h3 className="font-['Playfair_Display'] text-[26px] leading-tight text-[#2D0004] mb-2">
          {project.title}
        </h3>

        <p className="font-['Inter'] text-[12px] tracking-[1.8px] uppercase text-[#544242]">
          {project.subcategory}
        </p>
      </div>
    </motion.a>
...
========================== */}
<div className="hidden md:grid w-full grid-cols-2 lg:grid-cols-3 gap-8 min-h-[832px]">
  {filteredProjects.map((project, index) => (
    <motion.div
      key={project.id}
      initial={{ opacity: 0, y: 30 }}
